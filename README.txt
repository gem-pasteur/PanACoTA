...
You can enjoy the recipe [here](https://github.com/gem-pasteur/PanACoTA/commits/cake-recipe) (read from bottom to top, and don't forget to click on the `...` to get the full message)
and learn how to write commit messages at the same time ;)

PS: If you want a summary, it's [Here](https://github.com/gem-pasteur/PanACoTA/blob/cake-recipe/recipe.pdf)
