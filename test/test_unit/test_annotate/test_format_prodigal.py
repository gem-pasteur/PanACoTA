...
def test_create_gff(caplog):
    ...
    caplog.set_level(logging.DEBUG)
    logger = logging.getLogger("test_prodigal")
    gfffile = os.path.join(TEST_ANNOTE, "original_name.fna-prodigalRes", "prodigal_out_for_test.gff")
    contigs = {"JGIKIPgffgIJ": "test.0417.00002.0001",
               "toto": "test.0417.00002.0002",
               "other_header": "test.0417.00002.0003",
               "my_contig": "test.0417.00002.0004",
...
def test_create_gff_wrong_start(caplog):
    ...
    the start position in the lstinfo file (which was taken from the ffn file generated by prodigal)
    """
    caplog.set_level(logging.DEBUG)
    logger = logging.getLogger("test_prodigal")
    gfffile = os.path.join(TEST_ANNOTE, "original_name.fna-prodigalRes", "prodigal_out_for_test-wrong-start.gff")
    contigs = {"JGIKIPgffgIJ": "test.0417.00002.0001",
               "toto": "test.0417.00002.0002",
               "other_header": "test.0417.00002.0003",
               "my_contig": "test.0417.00002.0004",
    ...
    assert ("Files prodigal_out_for_test-wrong-start.ffn and prodigal_out_for_test-wrong-start.gff "
            "(in prodigal tmp_files: original_genome_name-prodigalRes) "
            "do not have the same start value for gene EPKOMDHM_00008 (78 in gff, 77 in ffn") in caplog.text
